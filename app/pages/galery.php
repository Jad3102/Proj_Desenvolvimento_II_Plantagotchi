<section id="galery" class="container-fluid galery py-5">
    <div class="row">
        ...
        <div class="container-fluid fotos d-flex flex-wrap justify-content-center">
            <img class="foto_individual" id="imagem_1" src="imagem1.jpg" alt="Descrição 1">
            <img class="foto_individual" id="imagem_2" src="imagem2.jpg" alt="Descrição 2">
            <img class="foto_individual" id="imagem_3" src="imagem3.jpg" alt="Descrição 3">
